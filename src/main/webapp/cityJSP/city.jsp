...
<div align="center"class="w3-container w3-blue-grey w3opacity w3-center">
    ...
    <form action="${pageContext.request.contextPath}/city" method="post" id="search"></form>
    <form action="${pageContext.request.contextPath}/city" method="post" id="edit"></form>
    <form action="${pageContext.request.contextPath}/city" method="post" id="create"></form>
    <form action="${pageContext.request.contextPath}/city" method="post" id="copy"></form>
        <%--Поле поиска--%>
    ...
    <input type="hidden" name="name_field" value="CITY_NAME" form="search">
    ...
    <input type="hidden" name="transitionPage" value="cityJSP/updateCity.jsp" form="edit">
    ...
    <input type="hidden" name="transitionPage" value="cityJSP/addCity.jsp" form="create">
...
<table class="w3-table w3-bordered w3-striped w3-hoverable">
    <tr align="center">
        ...
        <td>
            <form action="${pageContext.request.contextPath}/city" method="post">
                ...
                <input type="hidden" name="field_name" value="CITY_NAME">
    ...
    <c:forEach var="City" items="${list}">
        <tr>
            ...
            <td>
                <input form="copy" type="radio" name="id_copy_no_on_servlet" value="${City.id}">
            </td>
        </tr>
    </c:forEach>
</table>
